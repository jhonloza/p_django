                      ...
                      new Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                'Creando un entorno de Django e inicializarlo',
                                style: TextStyle(
                                  fontFamily: 'PatuaOne',
                                  fontSize: 38,
                                ),
                              ...
                              Image.network(
                                  'https://i.ibb.co/k0CFqKd/image.png'),
                              //paso 2
                              Text(
                              ...
                              Image.network(
                                  'https://i.ibb.co/vDF8VB1/image.png'),
                              //paso 3
                              Text(
                              ...
                              Image.network(
                                  'https://i.ibb.co/g3KGbd6/image.png'),
                              //paso 4
                              Text(
                              ...
                              Image.network(
                                  'https://i.ibb.co/CHQ6r7z/image.png'),
                              //paso 5
                              Text(
                              ...
                              Text(
                                'Estructura de la aplicacion Django',
                                style: TextStyle(
                                  fontFamily: 'PatuaOne',
                                  fontSize: 38,
                                ),
                              ...
                              Image.network(
                                  'https://i.ibb.co/2dtngy1/image.png'),
                              Text(
                                'Los archivos indicados son:',
                                style: TextStyle(
                                  fontFamily: 'PatuaOne',
                                  fontSize: 38,
                                ),
...
° mysite/wsgi.py: Un punto de entrada para que los servidores web compatibles con WSGI puedan servir su proyecto. Consulte :doc:`/howto/deployment/wsgi/index`para más detalles.\n\n''',
                              ...
                              Text(
                                'Vistas a manejar y editar en Django',
                                style: TextStyle(
                                  fontFamily: 'PatuaOne',
                                  fontSize: 38,
                                ),
                              ...
                              Image.network(
                                  'https://i.ibb.co/c66XMYg/image.png'),
                              Text(
...
Creamos nuestra ruta de templates/vista1 como se presenta la siguiente rama\n\n''',
                              ...
                              Image.network(
                                  'https://i.ibb.co/tpVZVS6/image.png'),
                              ...
                              Image.network(
                                  'https://i.ibb.co/ySGvtRw/image.png'),
                              ...
                              Image.network(
                                  'https://i.ibb.co/W6HZ5Sb/image.png'),
                              Text(
                              ...
                              Image.network(
                                  'https://i.ibb.co/ChkLD3J/image.png'),
                              Text(''),
                              Image.network(
                                  'https://i.ibb.co/C7zzx0R/image.png'),
                              Text(
                              ...
                              Image.network(
                                  'https://i.ibb.co/zP02YG8/image.png'),
                              Text(
...
En este archivo importaremos la libreria include para incorporar las rutas de mas aplicaciones\n\n''',
                              ...
                              Image.network(
                                  'https://i.ibb.co/M1YyT4j/image.png'),
                              Text(
                              ...
                              Image.network(
                                  'https://i.ibb.co/0jQ4BMh/image.png'),
