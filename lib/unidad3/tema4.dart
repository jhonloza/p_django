...
class Tema34 extends StatelessWidget{
  ...
  Tema34({Key key, this.usuario}):super(key: key);
  @override
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Column(
                    children: [
                      new Text('Bases de Datos en Django',
                        style: TextStyle(
                          fontFamily: 'PatuaOne',
                          fontSize: 38,
                        ),
                      ...
                      new Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text('Motores de base de datos dispobnibles',
                              style: TextStyle(
                                fontFamily: 'PatuaOne',
                                fontSize: 38,
                              ),
...
\t - Oracle - 'django.db.backends.oracle'\n\n''',
                            ...
                            Image.network('https://i.ibb.co/TLxTfPT/image.png'),
                            Text(
                              '''\nPostgreSQL''',
                              style: TextStyle(fontFamily: 'PatuaOne', fontSize: 24),
                              textAlign: TextAlign.justify,
                            ),
                            Image.network('https://i.ibb.co/Mg3f50P/image.png'),
                            Text(
                              '''\nMicrosoft SQL Server''',
                              style: TextStyle(fontFamily: 'PatuaOne', fontSize: 24),
                              textAlign: TextAlign.justify,
                            ),
                            Image.network('https://i.ibb.co/BfjpGvM/image.png'),
                            Text(
                              '''\nOracle''',
                              style: TextStyle(fontFamily: 'PatuaOne', fontSize: 24),
                              textAlign: TextAlign.justify,
                            ),
                            Image.network('https://i.ibb.co/ydfFnFj/image.png'),
                            Text(
                            ...
                            Image.network('https://i.ibb.co/frShQxt/image.png'),
                            Text('Configuracion de una base de datos',
                              style: TextStyle(
                                fontFamily: 'PatuaOne',
                                fontSize: 38,
                              ),
                            ...
                            Image.network('https://i.ibb.co/D5CC1mh/image.png'),
                            Text('Creacion de la base',
                              style: TextStyle(
                                fontFamily: 'PatuaOne',
                                fontSize: 38,
                              ),
                            ...
                            Image.network('https://i.ibb.co/0DSztKB/image.png'),
                            Text(
                              '\nLa cual creara las siguientes tablas a utilizar.\n\n',
                              style: TextStyle(fontFamily: 'PatuaOne', fontSize: 24),
                              textAlign: TextAlign.justify,
                            ),
                            Image.network('https://i.ibb.co/Gvt5fX4/image.png'),
                            Text(
                            ...
                            TextButton(onPressed: (){
                              launch('https://docs.djangoproject.com/es/3.1/intro/tutorial02/');
                            }, child: Text(
